...
class Test_Policy():
    ...
    def evaluate_policy_stochastic(self):
        ...
        actor_test.load_state_dict(torch.load('./param_DPPO_Copy_V2/save_net_param/actor_net_DPPO65880000.pkl'))
        critic_test.load_state_dict(torch.load('./param_DPPO_Copy_V2/save_net_param/critic_net_DPPO65880000.pkl'))
    ...
    def plot_tracking_trajectory(self, actor_test, critic_test):
        if args.use_state_norm:
            ...
            state_norm.load('./param_DPPO_V2/save_norm_param/shared_state_normalization_params8760000.pkl')
